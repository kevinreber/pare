...
/** Study Groups*/
export const JOIN_STUDY_GROUP = 'ADD_NEW_MESSAGE';
export const JOIN_STUDY_GROUP_ERROR = 'ADD_NEW_MESSAGE_ERROR';
export const DELETE_STUDY_GROUP = 'DELETE_MESSAGE';
export const DELETE_STUDY_GROUP_FAIL = 'DELETE_MESSAGE_FAIL';
